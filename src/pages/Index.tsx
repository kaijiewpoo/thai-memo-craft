...
const ThaiMemoForm = () => {
  ...
  return <div className="min-h-screen bg-gray-200 dark:bg-gray-800 p-8 pt-[1.5cm] flex justify-center items-start font-sarabun relative print:bg-white">
      {/* A4 PAPER FRAME */}
        ...
        <main className="text-[16pt]">
          <div className="space-y-1">
            <div className="flex items-baseline">
              ...
              <Input id="department" name="department" value={formData.department} onChange={handleInputChange} className={cn(inputStyle, placeholderStyle)} placeholder="กรอกข้อมูล" />
            </div>
            ...
            <div className="flex items-baseline gap-8">
              <div className="flex items-baseline w-1/2">
                ...
                <Input id="referenceNumber" name="referenceNumber" value={formData.referenceNumber} onChange={handleInputChange} className={cn(inputStyle, placeholderStyle)} placeholder="กรอกข้อมูล" />
              </div>
              <div className="flex items-baseline w-1/2">
                ...
                <div className="flex-1 ml-2">
                  <Popover>
                    <PopoverTrigger asChild>
                      <Button variant={"ghost"} className={cn("w-full justify-start text-left font-normal text-[23px] p-0 h-auto border-b border-dotted border-black rounded-none hover:bg-transparent focus-visible:ring-0 focus-visible:ring-offset-0 bg-transparent", !formData.date && "text-muted-foreground")}>
            ...
            <div className="flex items-baseline">
              ...
              <Input id="subject" name="subject" value={formData.subject} onChange={handleInputChange} className={cn(inputStyle, placeholderStyle)} placeholder="กรอกข้อมูล" />
            </div>
          ...
          <div className="mt-4 space-y-2">
            <Textarea name="reason" value={formData.reason} onChange={handleInputChange} placeholder="กรอกข้อมูล..." rows={4} maxLength={600} className={cn("w-full text-[17pt] leading-[2.5] border-none focus:ring-0 shadow-none bg-transparent p-0 [text-indent:1cm] max-h-[5.5em] resize-none overflow-y-auto print:overflow-hidden", placeholderStyle)} style={{
            minHeight: "4em",
            maxHeight: "5.5em",
            lineHeight: "2.5"
          }} />
            <Textarea name="objective" value={formData.objective} onChange={handleInputChange} placeholder="กรอกข้อมูล..." rows={4} maxLength={600} className={cn("w-full text-[17pt] leading-[2.5] border-none focus:ring-0 shadow-none bg-transparent p-0 [text-indent:1cm] max-h-[5.5em] resize-none overflow-y-auto print:overflow-hidden", placeholderStyle)} style={{
            minHeight: "4em",
            maxHeight: "5.5em",
            lineHeight: "2.5"
          }} />
            <Textarea name="conclusion" value={formData.conclusion} onChange={handleInputChange} placeholder="กรอกข้อมูล..." rows={4} maxLength={600} className={cn("w-full text-[17pt] leading-[2.5] border-none focus:ring-0 shadow-none bg-transparent p-0 [text-indent:1cm] max-h-[5.5em] resize-none overflow-y-auto print:overflow-hidden", placeholderStyle)} style={{
            minHeight: "4em",
            maxHeight: "5.5em",
            lineHeight: "2.5"
          }} />
